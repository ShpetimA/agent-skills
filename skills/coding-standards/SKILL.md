...
description: TypeScript coding standards and design taste. Use when working on TypeScript code; when adding or changing domain models, modules, adapters, parsers, typed errors, async workflows, tests, TypeScript contracts, or Effect code; or when another engineering skill needs the user's coding standards.
---
...
2. **Classify the change.** Identify the concerns touched: domain state, parsing, errors, observability, modules, async, tests, TypeScript contracts, or Effect.
...
Do not treat this root file as enough context for library, runtime, schema, error, testing, Effect, or toolchain choices.
